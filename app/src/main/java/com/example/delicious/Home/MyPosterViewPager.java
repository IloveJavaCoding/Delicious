...
public class MyPosterViewPager extends RelativeLayout {
    private static final int[] IMAGE_IDS = { R.drawable.prompt, R.drawable.ad, R.drawable.ad2, R.drawable.ad1};
    //	private static final int[] IMAGE_IDS = { R.drawable.image6 };
    // 点点的大小
    ...
    private void init(Context context) {
        ...
        setPosterImages(context, IMAGE_IDS);
